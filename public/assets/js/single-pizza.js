...
function getPizza() {
  ...
  fetch(`/api/pizzas/${pizzaId}`)
    ...
    .then(printPizza)
    .catch(err => {
      alert('Cannot find a pizza with this ID! Taking you back to the hompage...');
      // move back one page in the history (like a 'back' button)
      window.history.back();
    });
};
